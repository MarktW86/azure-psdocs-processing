...
ms.date: 03/29/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ServiceManagement/Azure/v3.7.0/Azure.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ServiceManagement/Azure/v3.7.0/Azure.md
...
Get-AzureVNetGatewayIPsecParameters: Azure
...
Get-WAPackStaticIPAddressPool: Azure
...
New-WAPackStaticIPAddressPool: Azure
...
Remove-AzureReservedIP: Azure
Remove-AzureReservedIPAssociation: Azure
...
Remove-AzureStaticVNetIP: Azure
...
Remove-WAPackStaticIPAddressPool: Azure
...
Select-AzureStorSimpleResource: Resources
...
Set-AzureVNetGatewayIPsecParameters: Azure
...
Start-AzureStorSimpleBackupCloneJob: Backup
Start-AzureStorSimpleDeviceBackupJob: Backup
Start-AzureStorSimpleDeviceBackupRestoreJob: Backup
Start-AzureStorSimpleDeviceFailoverJob: Azure
Start-AzureStorSimpleLegacyVolumeContainerMigrationPlan: Azure
