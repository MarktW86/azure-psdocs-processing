...
ms.date: 05/01/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/armsql/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackAdmin/v0.9.8.1/Remove-AzureRMGalleryItem.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/armsql/azureps-cmdlets-docs/ResourceManager/AzureRM.AzureStackAdmin/v0.9.8.1/Remove-AzureRMGalleryItem.md
...
```
Remove-AzureRMGalleryItem -Name <String> [-ResourceGroup <String>] [-SubscriptionId <Guid>] [-AdminUri <Uri>]
