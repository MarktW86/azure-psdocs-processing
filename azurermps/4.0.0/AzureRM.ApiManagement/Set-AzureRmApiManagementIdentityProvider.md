...
ms.date: 05/11/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.ApiManagement/v4.0.0/Set-AzureRmApiManagementIdentityProvider.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/master/azureps-cmdlets-docs/ResourceManager/AzureRM.ApiManagement/v4.0.0/Set-AzureRmApiManagementIdentityProvider.md
...
Set-AzureRmApiManagementIdentityProvider -Context <PsApiManagementContext>
 ...
 [-AllowedTenants <String[]>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
