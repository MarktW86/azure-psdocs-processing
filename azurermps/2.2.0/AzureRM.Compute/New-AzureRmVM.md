...
ms.date: 05/01/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Compute/v2.1.0/New-AzureRmVM.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Compute/v2.1.0/New-AzureRmVM.md
...
```
New-AzureRmVM -ResourceGroupName <String> -Location <String> -VM <PSVirtualMachine> [-DisableBginfoExtension]
 [-Tags <Hashtable[]>] [-LicenseType <String>] [-InformationAction <ActionPreference>]
