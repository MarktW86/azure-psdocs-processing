...
ms.date: 04/27/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Network/v2.2.0/New-AzureRmNetworkInterfaceIpConfig.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Network/v2.2.0/New-AzureRmNetworkInterfaceIpConfig.md
...
## SYNOPSIS
Creates a network interface IPConfiguration.
...
## DESCRIPTION
The New-AzureRmNetworkInterfaceIpConfig cmdlet creates an Azure  network interface IPConfiguration for a network interface.
...
### -Name
Specifies the name of the network interface IPConfiguration.
