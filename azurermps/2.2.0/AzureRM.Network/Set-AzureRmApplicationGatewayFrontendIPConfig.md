...
ms.date: 05/01/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Network/v2.2.0/Set-AzureRmApplicationGatewayFrontendIPConfig.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/ResourceManager/AzureRM.Network/v2.2.0/Set-AzureRmApplicationGatewayFrontendIPConfig.md
...
### --------------------------  Example 1: Set a public IP as frontend IP of an application gateway  --------------------------
@{paragraph=PS C:\\\>}
...
### --------------------------  Example 2: Set a static private IP as the frontend IP of an application gateway  --------------------------
@{paragraph=PS C:\\\>}
...
### --------------------------  1: Set a dynamic private IP as the frontend IP of an application gateway  --------------------------
@{paragraph=PS C:\\\>}
