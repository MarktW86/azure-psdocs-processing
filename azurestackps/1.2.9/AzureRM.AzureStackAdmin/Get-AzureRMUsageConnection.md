...
ms.date: 05/02/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/AzureStack/AzureRM.AzureStackAdmin/v0.10.6/Get-AzureRMUsageConnection.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/AzureStack/AzureRM.AzureStackAdmin/v0.10.6/Get-AzureRMUsageConnection.md
...
### Example 1: Get information about the specified usage connection
```
Get-AzureRMUsageConnection -Name "sqlrpusageconnection" -ResourceGroup "UsageConnectionRG"
```

This example gets information for the "sqlrpusageconnection" usage connection in the "UsageConnectionRG" resource group.
