...
ms.date: 05/03/2017
content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/AzureStack/AzureRM.AzureStackStorage/v0.10.6/Get-ACSFarmMetric.md
original_content_git_url: https://github.com/Azure/azure-docs-powershell/blob/DuncanmaMSFT-patch-1/azureps-cmdlets-docs/AzureStack/AzureRM.AzureStackStorage/v0.10.6/Get-ACSFarmMetric.md
...
## SYNOPSIS
Gets the metrics of an ACS farm.
...
## DESCRIPTION
The **Get-ACSFarmMetric** cmdlet gets the metrics of an Azure Consistent Storage (ACS) farm.
...
### -FarmName
Specifies the name of the ACS farm that this cmdlet gets metrics.
